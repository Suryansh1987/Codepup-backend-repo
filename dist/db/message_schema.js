...
exports.ciMessages = (0, pg_core_1.pgTable)("ci_messages", {
    ...
    modificationApproach: (0, pg_core_1.varchar)("modification_approach", {
        length: 30,
    }).$type(),
...
exports.conversationStats = (0, pg_core_1.pgTable)("ci_conversation_stats", {
    ...
    lastModificationAt: (0, pg_core_1.timestamp)("last_modification_at", {
        withTimezone: true,
    }),
