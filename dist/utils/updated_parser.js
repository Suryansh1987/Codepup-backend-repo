...
class LLMCodeParser {
     ...
     */
    static generateStructureTree(codeFiles) {
        const structure = {};
     ...
     */
    static parseFrontendCode(input) {
        try {
            ...
            //@ts-ignore
            const codeFiles = Object.entries(codefilesData).map(
            //@ts-ignore
            ([path, content]) => ({
                path,
     ...
     */
    static flattenStructure(structure, basePath = "") {
        const paths = [];
        //@ts-ignore
     ...
     */
    static getFileStatus(structure, filePath) {
...
*/ 
//# sourceMappingURL=updated_parser.js.map